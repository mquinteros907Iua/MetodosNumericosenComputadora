/* =========================================================================
Spline_Cubico.c
- Interpolación por spline cúbico natural (a_k x^3 + b_k x^2 + c_k x + d_k por tramo)
...
- Resolución: Gauss con pivoteo parcial (mensajes claros ante pivote ~ 0).
======================================================================== */
...
int main(void)
{
	...
	double **A = NULL;
	double *b  = NULL;
	double *coeficientes = NULL;               /* [a0 b0 c0 d0 | a1 b1 c1 d1 | ...] */
	...
	while (1) {
		...
		case 2: {
			...
			/* armar A y b segun tu pseudocodigo */									//Este metodo crea y hace los calculos para el polinomio 						
